...
public class UpdateCustomerCommand {
    ...
    public UpdateCustomerCommand(UUID customerId, String businessName, String contactName, String email,
                                 String phone, AddressDto billingAddress, AddressDto shippingAddress) {
    ...
    public boolean equals(Object o) {
        ...
        UpdateCustomerCommand that = (UpdateCustomerCommand) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(customerId, businessName, contactName, email, phone, billingAddress, shippingAddress);
    }
